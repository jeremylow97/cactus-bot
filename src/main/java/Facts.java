...
public class Facts {
    public static String[] facts = {
            ...
            "out of 10 Americans are deficient in Potassium.",
            ...
            "ml of blood pumps through your brain every minute which is 15-20% of blood flow from the heart.",
    ...
    public static String getFacts() {
        int random = (int)(Math.random() * facts.length + 1) - 1;
